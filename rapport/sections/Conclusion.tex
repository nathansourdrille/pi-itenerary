...
\vspace{1cm}
\noindent\textbf{Répartition des tâches au sein de l'équipe :}

\begin{center}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
\textbf{Tâche} & \textbf{Ambroise} & \textbf{Paul} & \textbf{Dylan} & \textbf{Nathan} & \textbf{Rayen} \\
\hline
Montage capteurs & \checkmark &  & \checkmark &  &  \\
Paramétrage capteurs & \checkmark &  &  &  &  \\
Traitement des données &  & \checkmark &  &  &  \\
Acquisitions &  &  & \checkmark & \checkmark &  \\
Kalman &  & \checkmark &  &  &  \\
Fonctionnalité bonus &  & \checkmark &  &  &  \\
Rapport & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
\hline
\end{tabular}
\end{center}
