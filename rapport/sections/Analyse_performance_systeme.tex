...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[height = 300pt, width=\linewidth]{../traitements/mouvement_exterieur1/comparaison_latitude}
        \caption{ Comparaison latitude (Gps vs Téléphone) }
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[height = 300pt , width=\linewidth]{../traitements/mouvement_exterieur1/comparaison_longitude}
